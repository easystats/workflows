...
| R-CMD-check-strict.yaml      | Runs R CMD check and fails if there are any `WARNING`s or `NOTE`s                                             |
| R-CMD-check.yaml             | Runs standard R CMD check                                                                                     |
...
| lint-changed-files.yaml      | Runs `{lintr}` on the files that were modified to check for code quality issues                               |
